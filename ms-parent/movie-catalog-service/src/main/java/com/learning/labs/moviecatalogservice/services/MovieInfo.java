...
public class MovieInfo {
	...
	@Value("${default.movieInfoServiceEndpoint}")
	private String movieInfoEndpoint;
	...
	public CatalogItem getCatalogItem(MovieRating movieRating) {
		Movie movie = restTemplate.getForObject(movieInfoEndpoint + movieRating.getMovieId(), Movie.class);
