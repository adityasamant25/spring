...
public class UserRatingInfo {
	...
	@Value("${default.ratingsDataServiceEndpoint}")
	private String userRatingInfoEndpoint;

	@HystrixCommand(fallbackMethod = "getFallbackUserRating")
	public UserRating getUserRating(String userId) {
		return restTemplate.getForObject(userRatingInfoEndpoint + userId, UserRating.class);
	}
